...
在 `rules/02_USER.md` 里，有一个明确的观察：当编码变便宜后，人类测试/验证会成为整个开发闭环的限速器。这是对 X03 在当代的具体应用。代码生成成本趋近于零时，判断力（判断"什么值得维护"、"什么是好"）而非代码产出速度成为真正的竞争力。这意味着在 AI 时代，优化的重点应该从"如何更快地写代码"转向"如何更快地验证和判断代码的质量"。
